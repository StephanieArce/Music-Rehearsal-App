//
//  SavedSoundSectionsTableViewController.swift
//  Music Rehearsal App
//
//  Created by VJ on 11/14/14.
...
class SavedSoundSectionsTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return userSongClipTimeArray.count
    }

    
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("songSectionCell", forIndexPath: indexPath) as UITableViewCell
